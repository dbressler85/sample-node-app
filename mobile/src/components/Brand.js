...
const styles = StyleSheet.create({
  ...
  title: {
    ...
    textShadowRadius: 27, // a touch brighter neon bloom on screen titles
  ...
  topbarTitle: { color: colors.violetText, fontSize: 20, fontWeight: '900', textShadowColor: 'rgba(139,92,246,0.95)', textShadowRadius: 17, textShadowOffset: { width: 0, height: 0 } },
