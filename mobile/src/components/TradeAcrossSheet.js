...
const styles = StyleSheet.create({
  ...
  // Cap the sheet so a long league list can never push its top (title/first rows) off-screen — the
  // list inside scrolls instead. The bounded height is what lets the inner ScrollView actually scroll.
  sheet: { backgroundColor: colors.card, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, borderTopWidth: 1, borderColor: colors.border, maxHeight: '85%' },
