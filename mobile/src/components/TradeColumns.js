...
const styles = StyleSheet.create({
  ...
  colLabel: { color: colors.violetText, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 4 },
  ...
  sectionCap: { color: colors.violetText, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.5, opacity: 0.8, marginBottom: 2 },
});
