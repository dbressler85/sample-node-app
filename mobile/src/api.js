...
export const api = {
  ...
  playerSchedule: (id, tep) => request(`/api/players/${id}/schedule${tep ? '?tep=1' : ''}`),
  ...
  editClaim: (leagueId, claimId, body) => request(`/api/leagues/${leagueId}/waivers/${claimId}`, { method: 'PATCH', body }),
