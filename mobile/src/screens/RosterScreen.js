...
const styles = StyleSheet.create({
  ...
  summaryCell: { flex: 1 },
  summaryLabel: { color: colors.violetText, fontSize: 11, fontWeight: '700' },
  ...
  sortLabel: { color: colors.violetText, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.4, marginRight: 2 },
