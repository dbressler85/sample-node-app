...
const styles = StyleSheet.create({
  ...
  draftedTag: { color: colors.bad, fontSize: 11, lineHeight: 13, fontWeight: '900', marginLeft: 6, borderWidth: 1, borderColor: colors.bad, borderRadius: 4, paddingHorizontal: 4, paddingVertical: 1, overflow: 'hidden' },
  ...
  addBtn: { borderWidth: 1, borderColor: colors.accent, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6, marginLeft: 10 },
  ...
  addHint: { color: colors.violetText, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.4, marginBottom: 8 },
