...
const styles = StyleSheet.create({
  ...
  fitNeed: { color: colors.violetText, fontSize: 11, fontWeight: '800' },
  fitSurp: { color: colors.violetText, fontSize: 11, fontWeight: '800' },
  ...
  buildColLabel: { color: colors.textDim, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8 },
  ...
  dirPillText: { fontSize: 11, fontWeight: '900', letterSpacing: 0.5 },
