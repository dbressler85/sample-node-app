...
const styles = StyleSheet.create({
  ...
  avatarPosText: { color: colors.onAccent, fontSize: 11, fontWeight: '900' },
  ...
  valueLabel: { color: colors.violetText, fontSize: 11, fontWeight: '700' },
  valueSpread: { color: colors.gold, fontSize: 11, fontWeight: '700', marginTop: 2, maxWidth: 92, textAlign: 'center' },
  ...
  lensValLabel: { color: colors.violetText, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 2 },
