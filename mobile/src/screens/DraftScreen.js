...
const styles = StyleSheet.create({
  ...
  clock: { backgroundColor: colors.good + '22', borderColor: colors.good, borderWidth: 1, borderRadius: 12, padding: 14, marginTop: 12 },
  clockText: { color: colors.good, fontSize: 16, fontWeight: '900' },
  ...
  avRowLive: { borderColor: colors.good },
  ...
  avValue: { color: colors.accent, fontSize: 16, fontWeight: '900', minWidth: 30, textAlign: 'right' },
});
