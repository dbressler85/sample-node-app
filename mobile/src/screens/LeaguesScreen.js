...
const styles = StyleSheet.create({
  ...
  dlChip: { color: colors.textDim, backgroundColor: colors.cardAlt, fontSize: 11, lineHeight: 13, fontWeight: '800', paddingHorizontal: 7, paddingVertical: 2, borderRadius: 5, overflow: 'hidden' },
