...
const styles = StyleSheet.create({
  ...
  chip: { fontSize: 11, lineHeight: 13, fontWeight: '800', paddingHorizontal: 7, paddingVertical: 2, borderRadius: 6, overflow: 'hidden' },
  ...
  mine: { color: colors.good, fontSize: 11, lineHeight: 13, fontWeight: '900', marginLeft: 6, borderWidth: 1, borderColor: colors.good, borderRadius: 4, paddingHorizontal: 4, paddingVertical: 1, overflow: 'hidden' },
  tagMark: { fontSize: 13, fontWeight: '900', marginLeft: 6 },
  meta: { color: colors.textDim, fontSize: 12, marginTop: 2 },
  ptsLine: { flexDirection: 'row', alignItems: 'center', gap: 12, marginTop: 4 },
  ptsItem: { fontSize: 12 },
  ptsLabel: { color: colors.violetText, fontSize: 11, fontWeight: '800', letterSpacing: 0.4 },
  ...
  trendUnit: { color: colors.textDim, fontSize: 11, fontWeight: '700', marginTop: 1 },
