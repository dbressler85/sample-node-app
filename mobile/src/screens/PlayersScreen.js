...
const styles = StyleSheet.create({
  ...
  mine: { color: colors.good, fontSize: 11, fontWeight: '900', marginLeft: 6, borderWidth: 1, borderColor: colors.good, borderRadius: 4, paddingHorizontal: 4, paddingVertical: 1, overflow: 'hidden' },
